  ...
  return (
    <>
      <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
            ...
            {userRole === 'PERSONAL_DOCTOR' && 'Personal Doctor Dashboard'}
          </h2>
      ...
      <div className="mb-4 sm:mb-6 grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        {userRole === 'SUPER_ADMIN' && (
          <>
            ...
            <div className="group rounded-xl border border-gray-200 bg-white p-3 sm:p-4 shadow-sm transition-shadow duration-200 hover:shadow-lg dark:border-gray-800 dark:bg-white/[0.03]">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Total Personal Doctors</p>
                  <p className="mt-1 text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                    {stats?.totalPersonalDoctors?.toLocaleString() || '0'}
                  </p>
                </div>
                <div className="hidden sm:flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-indigo-100 dark:bg-indigo-500/20 ml-2 flex-shrink-0">
                  <Stethoscope className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600 dark:text-indigo-400" />
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-xl border border-gray-200 bg-white p-3 sm:p-4 shadow-sm transition-shadow duration-200 hover:shadow-lg dark:border-gray-800 dark:bg-white/[0.03]">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Hospital Patients</p>
                  <p className="mt-1 text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                    {stats?.totalHospitalPatients?.toLocaleString() || '0'}
                  </p>
                </div>
                <div className="hidden sm:flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-500/20 ml-2 flex-shrink-0">
            ...
            <div className="group rounded-xl border border-gray-200 bg-white p-3 sm:p-4 shadow-sm transition-shadow duration-200 hover:shadow-lg dark:border-gray-800 dark:bg-white/[0.03]">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Personal Doctor Patients</p>
                  <p className="mt-1 text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                    {stats?.totalPersonalDoctorPatients?.toLocaleString() || '0'}
                  </p>
                </div>
                <div className="hidden sm:flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-500/20 ml-2 flex-shrink-0">
                  <Users className="h-5 w-5 sm:h-6 sm:w-6 text-teal-600 dark:text-teal-400" />
                </div>
              </div>
            </div>
          </>
        ...
        {/* Personal Doctor Stats */}
        {userRole === 'PERSONAL_DOCTOR' && (
          <>
            <div className="group rounded-xl border border-gray-200 bg-white p-3 sm:p-4 shadow-sm transition-shadow duration-200 hover:shadow-lg dark:border-gray-800 dark:bg-white/[0.03]">
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
      ...
      {/* Latest Hospital Patients - Super Admin Only */}
      {userRole === 'SUPER_ADMIN' && stats?.recentHospitalPatients && stats.recentHospitalPatients.length > 0 && (
        <div className="mb-8 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Latest Hospital Patients</h3>
                <p className="mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                  Last 5 patients added by Hospital Doctors
                </p>
              </div>
              {stats.recentHospitalPatients.length === 5 && (
                <Link
                  to="/hospital/hospital-patients"
          ...
          <div className="hidden lg:block overflow-x-auto">
            <table className="w-full min-w-[1000px]">
              ...
              <tbody className="bg-white dark:bg-white/[0.03] divide-y divide-gray-200 dark:divide-gray-800">
                {stats.recentHospitalPatients.map((patient: any) => {
      ...
      {/* Latest Personal Doctor Patients - Super Admin Only */}
      {userRole === 'SUPER_ADMIN' && stats?.recentPersonalDoctorPatients && stats.recentPersonalDoctorPatients.length > 0 && (
        <div className="mb-8 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Latest Personal Doctor Patients</h3>
                <p className="mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                  Last 5 patients added by Personal Doctors
                </p>
              </div>
              {stats.recentPersonalDoctorPatients.length === 5 && (
                <Link
                  to="/hospital/personal-doctor-patients"
                  className="text-sm font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 transition-colors"
                >
                  View All →
                </Link>
          ...
          <div className="hidden lg:block overflow-x-auto">
            <table className="w-full min-w-[800px]">
              <thead className="bg-gray-50 dark:bg-gray-800/50 border-b-2 border-gray-200 dark:border-gray-700">
                <tr>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[180px]">Patient</th>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[200px]">Personal Doctor</th>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[200px]">Address</th>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[200px]">Diagnosis</th>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[220px]">Treatment</th>
                  <th className="px-4 py-3.5 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider w-[140px]">Created At</th>
              ...
              <tbody className="bg-white dark:bg-white/[0.03] divide-y divide-gray-200 dark:divide-gray-800">
                {stats.recentPersonalDoctorPatients.map((patient: any) => {
                  const doctorName = typeof patient.doctorId === 'object' ? patient.doctorId?.name : 'N/A';
      ...
      {/* Latest Patients - Other Roles */}
      {userRole !== 'SUPER_ADMIN' && stats?.recentPatients && stats.recentPatients.length > 0 && (
        <div className="mb-8 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-800">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div>
                ...
                <p className="mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                  ...
                  {userRole === 'PERSONAL_DOCTOR' && 'Last 5 patients created by you'}
                </p>
              </div>
            ...
            {stats.recentPatients.map((patient: any) => {
              ...
              return (
                <div key={patient._id} className="bg-gray-50 dark:bg-gray-800/30 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
                  ...
                  {/* Details Grid */}
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    {userRole !== 'PERSONAL_DOCTOR' && userRole === 'SUPER_ADMIN' && hospitalName !== 'N/A' && (
                      <div className="flex items-start gap-1.5">
                        <span className="text-gray-500 dark:text-gray-400 font-medium flex-shrink-0">Hospital:</span>
                        <span className="text-gray-700 dark:text-gray-300 truncate">{hospitalName}</span>
                      </div>
                    )}
                    {userRole !== 'PERSONAL_DOCTOR' && (userRole === 'SUPER_ADMIN' || userRole === 'HOSPITAL') && clinicName !== 'N/A' && (
                      <div className="flex items-start gap-1.5">
                        <span className="text-gray-500 dark:text-gray-400 font-medium flex-shrink-0">Clinic:</span>
                        <span className="text-gray-700 dark:text-gray-300 truncate">{clinicName}</span>
                      </div>
                    )}
                    {userRole !== 'PERSONAL_DOCTOR' && (userRole === 'SUPER_ADMIN' || userRole === 'HOSPITAL' || userRole === 'CLINIC') && doctorName !== 'N/A' && (
                      <div className="flex items-start gap-1.5">
                        <span className="text-gray-500 dark:text-gray-400 font-medium flex-shrink-0">Doctor:</span>
                        <span className="text-gray-700 dark:text-gray-300 truncate">{doctorName}</span>
                      </div>
